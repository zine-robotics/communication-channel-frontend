...
function Robo(){
    return (
        <div>
        <div className="robot"><svg version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g id="hover">
            ...
            <g id="body">
              ...
              <g id="progress-indicator">
                <g id="divet">
                  ...
                  <polygon id="shadow-right_1_" fill="#BABEB7" points="416.168,505.169 420.5,503.564 425.182,524.775 420.682,521.823 			" />
                  <polygon id="shadow-left" fill="#8F918D" points="183.677,505.577 179.34,504.049 174.797,524.685 179.297,521.736 			" />
            ...
            <g id="head">
              ...
              <g id="eyes">
                <ellipse id="left_1_" fill="#2C3332" cx={231} cy="316.667" rx="6.333" ry={17} />
                <ellipse id="right_1_" fill="#2C3332" cx={369} cy="316.667" rx="6.334" ry={17} />
              </g>
              <g id="indicators">
                ...
                <g id="leds">
                  <circle id="yellow" fill="#F0C419" cx="300.418" cy={207} r="8.084" />
                  <circle id="red" fill="#E64C3C" cx="324.67" cy={206} r="8.084" />
